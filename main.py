...
def preprocess_text(dataframe):
    ...
    dataframe['labels'] = dataframe['MaxVehicleSeverity']
    return dataframe
...
def initialize_model(tokenizer, dataframe):
    model = transformers.AutoModelForSequenceClassification.from_pretrained(
        'bert-base-uncased', num_labels=dataframe['labels'].nunique()
    )
...
def main():
    ...
    training_args = create_training_args(
        best_run.hyperparameters['learning_rate'],
        best_run.hyperparameters['per_device_train_batch_size'],
        best_run.hyperparameters['num_train_epochs'],
        best_run.hyperparameters['weight_decay']
    )
